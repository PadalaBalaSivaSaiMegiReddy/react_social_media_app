  ...
  if(req.body.id!==req.params.id){
    ...
    try {
      ...
      if(!user.followers.includes(req.body.userId)){
        ...
        res.status(304).json("You already follow the current user");
      }
    ...
    res.status(409).json("You cannot follow yourself");
  }
})
  ...
  if(req.body.id!==req.params.id){
    ...
    try {
      ...
      if(user.followers.includes(req.body.userId)){
        ...
        res.status(409).json("You don not follow the current user");
      }
